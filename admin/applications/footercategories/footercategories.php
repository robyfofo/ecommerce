 ...
 * admin/footercategories/footercategories.php v.1.0.0. 16/02/2021
*/
...
switch(Core::$request->method) {	
	...
	case 'insertItem':
		...
		if ($_POST) {	
			...
			//$_POST['created'] = '1999-01-01 20:01:01';
	...
	case 'updateItem':
		...
		if ($_POST) {
			...
			//$_POST['created'] = '1980s-01-01 20:01:01';
			//ToolsStrings::dump($_POST);
	...
	default:
		...
		$App->pageSubTitle = preg_replace('/%ITEM%/',Config::$localStrings['categoria'],Config::$localStrings['lista %ITEM%']);		
		$App->viewMethod = 'list';	
	break;
}
...
switch((string)$App->viewMethod) {
	case 'form':	
		$App->templateApp = 'formFootercategory.html';	
		$App->jscript[] = '<script src="'.URL_SITE_ADMIN.$App->pathApplications. Core::$request->action.'/templates/'.$App->templateUser.'/js/formFootercategory.js"></script>';
	break;
	
	default:
	case 'list':
		$App->templateApp = 'listFootercategories.html';	
		$App->jscript[] = '<script src="'.URL_SITE_ADMIN.$App->pathApplications. Core::$request->action.'/templates/'.$App->templateUser.'/js/listFootercategories.js"></script>';
	break;
}	
?>