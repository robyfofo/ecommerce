...
switch((string)$App->viewMethod) {
	...
	case 'form':
		...
		$App->jscript[] = '<script src="'.URL_SITE_ADMIN.$App->pathApplications. Core::$request->action.'/templates/'.$App->templateUser.'/js/formLevel.js"></script>';
	break;

	case 'list':
	default:
		$App->templateApp = 'listLevels.html';		
		$App->jscript[] = '<script src="'.URL_SITE_ADMIN.$App->pathApplications. Core::$request->action.'/templates/'.$App->templateUser.'/js/listLevels.js"></script>';
