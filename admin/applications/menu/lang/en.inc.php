<?php
/* admin/menu/lang/en.inc.php v.1.0.0. 22/03/2021 */
$localStrings = array_merge($localStrings,array
	(
        ...
        'menupages'=>array(
            ...
            'title'=>'Il menu pagine dinamiche','info'=>'Il menu generato dal modulo pages è in genere il menu principale del sito, dove vengono mostrate nel menu le pagine dinamiche gestite dal modulo stesso'
        ),
