 ...
 * admin/module-XXX/configuration.php v.1.0.0. 15/07/2021
*/
...
switch(Core::$request->method) {
	case 'updateConf':
		...
		if (Core::$resultOp->error > 0) { die('errore db modifica configurazione'); ToolsStrings::redirect(URL_SITE_ADMIN.'error/db'); }
