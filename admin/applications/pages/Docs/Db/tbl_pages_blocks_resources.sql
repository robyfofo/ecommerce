...
--
-- Host: localhost
-- Creato il: Feb 12, 2018 alle 10:11
...
--
-- Struttura della tabella `tbl_pages_blocks_resources`
--

CREATE TABLE `tbl_pages_blocks_resources` (
  `id` int(8) NOT NULL,
...
--
-- Indici per le tabelle `tbl_pages_blocks_resources`
--
ALTER TABLE `tbl_pages_blocks_resources`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT per la tabella `tbl_pages_blocks_resources`
--
ALTER TABLE `tbl_pages_blocks_resources`
