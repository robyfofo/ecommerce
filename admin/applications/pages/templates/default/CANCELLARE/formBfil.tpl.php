<!-- wscms/pages/formBfil.tpl.php v.3.5.2. 14/02/2018 -->
<div class="row">
...
<div class="row">
	<div class="col-md-12">	
		...
		<ul class="nav nav-tabs">
			...
			{% endfor %}
			<li><a href="#file-tab" data-toggle="tab">{{ Lang['file']|capitalize }} <i class="fa"></i></a></li>
				...
				<div class="tab-pane{% if lang == Lang['user'] %} active{% endif %}" id="datibase{{ lang }}-tab">
					<fieldset class="form-group">
						<div class="form-group">
							...
							<div class="col-md-7">
								<input{% if lang == Lang['user'] %} required{% endif %} type="text" class="form-control" name="title_{{ lang }}" placeholder="{{ Lang['inserisci un titolo']|capitalize }} {{ lang }}" id="title_{{ lang }}ID" rows="3" value="{{ attribute(App.item, titleField) }}">
							</div>
						</div>
						<hr>
						<div class="form-group">
...
<!-- sezione file -->	
				<div class="tab-pane" id="file-tab">		
					<fieldset class="form-group">
						<div class="form-group">
							<label for="filenameID" class="col-md-2 control-label">{{ Lang['file']|capitalize }}</label>
							<div class="col-md-4">
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								...
								<a class="" href="{{ URLSITEADMIN }}{{ CoreRequest.action }}/downloadBfil/{{ App.item.id }}" title="{{ Lang['scarica il file']|capitalize }} {{ App.item.org_filename }}">
									{{ App.item.filename }}
								</a>							
								{% endif %}
							</div>			
...
<!-- sezione opzioni --> 
			...
			<div class="form-group">
				...
				<div class="col-md-2">				
					<a href="{{ URLSITEADMIN }}{{ CoreRequest.action }}/listBfil" title="{{ Lang['torna alla lista']|capitalize }}" class="btn btn-success">{{ Lang['indietro']|capitalize }}</a>
				</div>
			</div>
		</form>
	</div>
