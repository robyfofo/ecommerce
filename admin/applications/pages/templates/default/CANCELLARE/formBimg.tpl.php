<!-- wscms/pages/formBimg.tpl.php v.3.5.2. 14/02/2018 -->
<div class="row">
...
<div class="row">
	<div class="col-md-12">	
		...
		<ul class="nav nav-tabs">
			...
			{% endfor %}
			<li><a href="#image-tab" data-toggle="tab">{{ Lang['immagine']|capitalize }} <i class="fa"></i></a></li>
					...
					<fieldset class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								...
								<a class="" href="{{ App.params.uploadDirs['bimg'] }}{{ App.item.filename }}" data-lightbox="image-1" data-title="{{ value.org_filename }}" title="{{ App.item.org_filename }}">
									<img  class="img-thumbnail"  src="{{ App.params.uploadDirs['bimg'] }}{{ App.item.filename }}" alt="{{ App.item.org_filename }}">
								</a>							
								{% endif %}
							</div>			
						</div>
...
<!-- sezione opzioni --> 
			...
			<div class="form-group">
				...
				<div class="col-md-2">				
					<a href="{{ URLSITEADMIN }}{{ CoreRequest.action }}/listBimg" title="{{ Lang['torna alla lista']|capitalize }}" class="btn btn-success">{{ Lang['indietro']|capitalize }}</a>
				</div>
			</div>
		</form>
	</div>
