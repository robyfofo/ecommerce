<!-- wscms/pages/formIgal.tpl.php v.3.5.2. 14/02/2018 -->
<div class="row">
...
<!-- sezione opzioni --> 
			...
			<div class="form-group">
				...
				<div class="col-md-2">				
					<a href="{{ URLSITEADMIN }}{{ CoreRequest.action }}/listIgal" title="{{ Lang['torna alla lista']|capitalize }}" class="btn btn-success">{{ Lang['indietro']|capitalize }}</a>
				</div>
			</div>
		</form>
	</div>
